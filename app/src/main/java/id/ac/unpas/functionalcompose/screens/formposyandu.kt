    ...
    Column(modifier = Modifier
        ...
        Row (modifier = Modifier
            ...
            Button(modifier = Modifier.weight(5f), onClick = {
                ...
                val item = posyandu(id, tanggal.value.text,
                    nama.value.text, berat.value.text)
                scope.launch {
                    posyanduDao.insertAll(item)
                }
